...
import { BarChart3, Eye, EyeOff, Loader2 } from 'lucide-react'  // Eye already imported
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-6">
              ...
              <div className="relative">
                ...
                <button type="button" onClick={() => setShowPw(!showPw)} className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-500 hover:text-gray-300">{showPw ? <Eye size={16} /> : <EyeOff size={16} />}</button>
              </div>
            </div>
